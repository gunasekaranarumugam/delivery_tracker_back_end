...
docker stop delivery-tracker-backend || true
docker rm delivery-tracker-backend || true

echo "Starting new container..."
docker run -d --name delivery-tracker-backend -p 8000:8000 294253399473.dkr.ecr.ap-south-1.amazonaws.com/delivery-tracker-back-end-main:latest
